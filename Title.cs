...
namespace SpartaTextRPG
{
    ...
    internal class Title
    {
        ...
        private void StartProlog()
        {
            ...
            ShowImage(3);
            Console.WriteLine("================================================================================");
            WriteChar("인간들의 대륙 \"내배움\"은 신비로운 힘과 환상적인 존재로 가득 차 있었다.", 50);
            WriteChar("그곳은 주 80시간 노동이라는 힘든 근무환경이 조성되어 있었지만,", 50);
            WriteChar("나름대로 만족하며 평화롭게 살아가고 있었다", 50);
            Console.ReadKey();
            ...
            Console.WriteLine();
            Console.WriteLine("================================================================================");
            WriteChar("어느날 마왕들의 하수인인 드래곤이 마물들을 이끌고 마을을 습격했다.", 50);
            WriteChar("마물들의 습격으로 폐허가 된 마을은 던전이 되었고, 많은 인간들이 죽어나갔다.", 50);
            WriteChar("살아남은 인간들은 마물들을 피해 숨었지만, 마왕들의 집요함에 결국 발견되었다.", 50);
            WriteChar("주인공 {0}의 가족 또한 이 습격을 피해갈 수 없었다.", 50, playerName);
            Console.ReadKey();
